...
public class World {
	...
	public void render(Graphics g) {
		...
		int yStart = (int) Math.max(0, game.getGameCamera().getyOffset() / Tile.TILEHIEGHT);
		int yEnd = (int) Math.min(height, (game.getGameCamera().getyOffset() + game.getHeight()) / Tile.TILEHIEGHT + 1);
